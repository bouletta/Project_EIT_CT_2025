...
addpath(genpath('C:\Program Files\OOEIT-main'))      % To adapt
addpath(genpath('C:\Users\boulette\Desktop\Depot2\Project_EIT_CT_2025\mat_aatae'))% To adapt
 
%%    %%%%%%%%%%  Parallel computing Toolbox prefered for this driver, otherwise it will be sequentiel %%%%%%%
% go 'Home' then 'Add-Ons' then type ' Parallel computing Toolbox' then
% install.
%%


baseFolder  = 'meshes_mat_sujetss';   %To adapt to wherver you have the library
refSubject  = 's0011'; %chosen subject where we pick the reference slice
refSliceNum = 115;  %index of slice
