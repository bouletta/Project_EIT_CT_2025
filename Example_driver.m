...
baseFolder  = 'meshes_mat_sujetss'; % To adapt to wherever you have the libary


refSubject  = 's0011'; % subject
refSliceNum = 0; %index of slice
n_el =16; %number of elctodes
L=3.5;                     %% length of electodes in cm
